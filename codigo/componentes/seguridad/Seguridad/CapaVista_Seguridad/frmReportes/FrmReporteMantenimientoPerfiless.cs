...
{
    public partial class FrmReporteMantenimientoPerfiless : Form
    {
        private ClsModeloRoles roles = new ClsModeloRoles();
        public FrmReporteMantenimientoPerfiless()
        {
            InitializeComponent();
        }

        private void FrmReporteMantenimientoPerfiless_Load(object sender, EventArgs e)
        {
